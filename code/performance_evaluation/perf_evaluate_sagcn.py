...
def performance_evaluation_sagcn():
    ...
    num_sites = [50, 100, 150, 200, 250, 300, 350]
    #num_sites = [100]
    ...
    for site in num_sites:
        ...
        metric_file_nocalibrated = "metrics_sagcn_{}sites.csv".format(str(site))
        computeMetrics(y_real, probas_nocalibrated, output_dir + metric_file_nocalibrated)
        #metric_file_calibrated = "metrics_sagcn_{}sites_calibrated_11_19.csv".format(str(site))
